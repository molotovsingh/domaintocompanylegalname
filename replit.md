...
## Recent Changes
- **ROMANIAN JURISDICTION INTEGRATION COMPLETE**: Added comprehensive Romanian legal entity recognition with 12 distinct business structure types including limited liability companies (S.R.L.), joint-stock companies (S.A.), partnerships (S.N.C., S.C.S., S.C.A.), authorized individuals (P.F.A.), cooperatives, associations (Asociație), foundations (Fundație), and trust structures (Fiducie) per Romanian Companies Law (Law No. 31/1990) and Civil Code 2011 reforms - expanding jurisdictional coverage to 15 countries with 700+ corporate suffixes for enhanced Eastern European domain intelligence (July 03, 2025)
