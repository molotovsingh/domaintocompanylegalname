...
## Recent Changes
- **PERPLEXITY LLM INTEGRATION OPERATIONAL**: Fixed Perplexity API integration by correcting model name from outdated format to current "sonar" model, enabling real-time web search capabilities with LEI database access and 100% confidence legal entity extraction (apple.com → "Apple Inc." in 4.5 seconds with authoritative citations) (July 07, 2025)
