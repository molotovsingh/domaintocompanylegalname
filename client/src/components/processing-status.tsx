...
import { Loader2, Play, Square, AlertTriangle, CheckCircle, Settings, Clock, StopCircle, RefreshCw } from "lucide-react";
      ...
      <CardContent className="p-6">
        ...
        {!activeBatch && pendingBatches.length === 0 && (
          <div className="text-center p-6 bg-green-50 rounded-lg">
            ...
            <p className="text-sm text-gray-700 font-medium">Ready to Process</p>
