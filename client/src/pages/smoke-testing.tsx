...
import { CheckCircle, XCircle, Clock, Zap, Globe, Shield, ArrowLeft } from 'lucide-react';
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white rounded-lg p-2">
                  <Zap className="h-6 w-6" />
                </div>
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">Smoke Testing</h1>
                  <p className="text-sm text-gray-600">Compare scraping library performance</p>
                </div>
              </div>
            </div>
          </div>
