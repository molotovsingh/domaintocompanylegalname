...
export async function initBetaV2Database() {
  try {
    ...
    // Initialize arbitration tables
    await initArbitrationTables();
...
// Initialize arbitration tables
async function initArbitrationTables() {
  try {
    ...
    console.error('[Beta v2] [Arbitration] Table initialization error:', error);
